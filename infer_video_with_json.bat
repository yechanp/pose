...
ECHO %%f
python scripts/demo_inference_json.py --cfg configs/coco/resnet/256x192_res50_lr1e-3_2x.yaml --video %%f --save_video --outdir ./results/res50_json/ --detfile results/res50/video/%%~nxf.json --checkpoint pretrained_models/fast_res50_256x192.pth --pose_track
)